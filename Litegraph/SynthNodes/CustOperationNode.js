  ...
  return class OperationNode {
    constructor() {
      ...
      this.code_widget = this.addWidget(
        ...
        " ", // Standardwert
        (value) => {
          // Callback-Funktion, die ausgeführt wird, wenn sich der Wert ändert
          switch (value) {
            case "+":
    ...
    onExecute() {
      ...
      if (this.getInputData(0) && this.getInputData(1)) {
        ...
        this.properties["Out_leftSideOfEquation"] =
          In1_leftSideOfEquation +
          " " +
          this.properties["Operation"] +
          " " +
          In2_leftSideOfEquation;
        this.properties["Out_rightSideOfEquation"] =
          "(" +
          In1_rightSideOfEquation +
          ")" +
          " " +
          this.properties["Operation"] +
          " " +
          "(" +
          In2_rightSideOfEquation +
          ")";
        ...
        if (
          (In1_inputData &&
            In2_inputData &&
            this.properties.In1_isNumberNode != "UV" &&
            this.properties.In1_isNumberNode != "Parameter" &&
            this.properties.In2_isNumberNode != "UV" &&
            this.properties.In2_isNumberNode != "Parameter" &&
            In1_UV != In2_UV) ||
          (In1_inputData &&
            In2_inputData &&
            this.properties.In1_isNumberNode == "UV" &&
            this.properties.In2_isNumberNode != "UV" &&
            this.properties.In2_isNumberNode != "Parameter" &&
            In1_UV != In2_UV) || //Fall UV Node + Funktion
          (In1_inputData &&
            In2_inputData &&
            this.properties.In1_isNumberNode != "UV" &&
            this.properties.In1_isNumberNode != "Parameter" &&
        ...
        if (
          (In1_inputData &&
            ...
            this.properties.In2_isNumberNode != "UV" &&
            this.properties.In2_isNumberNode != "Parameter" &&
            In1_UV == In2_UV) || //Für den Fall, dass keine NumberNodes angeschlossen sind, dürfen zwei UV behaftete Nodes angeschlossen sein, sofern sie die gleiche uv betreffen
          (In1_inputData &&
            In2_inputData &&
            this.properties.In1_isNumberNode == "UV" &&
            this.properties.In2_isNumberNode != "UV" &&
          ...
          (In1_inputData &&
            ...
            this.properties.In1_isNumberNode != "Parameter" &&
            this.properties.In2_isNumberNode == "UV" &&
            In1_UV == In2_UV) || //Fall Funktion + UV Node
        ...
        if (this.properties["Fehlermeldung"] == "") {
          ...
          this.setOutputData(0, {
            uvValue: UV_Value_internal,
            value: this.properties["Result_Value"],
            ...
            toToolTip: () => {
                ...
                const tooltip = `${modifiedLeftSide} = ${Math.round(this.properties["Result_Value"]* 10) / 10}`;  
                return tooltip;
            }
          });
          this.outputs[0].color_on = adjustColor(
            "#00FF00",
            "#FF0000",
